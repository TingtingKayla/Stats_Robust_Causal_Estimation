...
for (k in start:end) {
  ...
  estimate.out=NULL
  estimate.out=pencompLassoOutcome(dataOR=simdatFit, data=simdatFit, varList=varList, propenVarList=propenVarList,
    ...
    tryCatch (
      {
        ...
        mulResult = pencompLassoOutcome(dataOR=simdatFit, data=bootSample, varList=varList, propenVarList=propenVarList,
                                        outcomeVarList0=outcomeVarList0, outcomeVarList1=outcomeVarList1,
                                        treat.varname=treat.varname, outcome.varname=outcome.varname ) 
