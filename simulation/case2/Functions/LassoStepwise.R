...
pencompLassoStepwise=function(dataOR, data, varList, propenVarList, outcomeVarList0, outcomeVarList1, treat.varname, outcome.varname, first) {
  tryCatch ( 
    {
      ...
      if ( length(propenVarList)==0 ){
        ...
        propenVarList=stepwiseLasso(data=data, varList=varList, treat.varname = treat.varname, outcome.varname=outcome.varname, first=first)
      } 
