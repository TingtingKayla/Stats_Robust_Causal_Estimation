...
######adaptive lasso on the propensity and prediction models separately
...
pencompLasso=function(dataOR, data, varList, propenVarList, outcomeVarList0, outcomeVarList1, treat.varname, outcome.varname) {
  tryCatch ( 
    {
      ...
      if ( length(propenVarList)==0 ){
        ...
        propenVarList=adapLassoT(Data=data, varList=varList, treat.varname = treat.varname, threshold=10^-8)
      } 
