...
for(sampleSize in c(200, 1000)){
  for(start in seq(1, 500, 100)){
    for (level in c("high", "moderate", "low") ) {
      for(modelType in c("lassoOutcome", "lassoSep", "lassoStepwiseT", "lassoStepwiseY", "allLasso") ) {
        
        #DIREC="M:/Private/varSelection/case4/"
        DIREC=paste0("/home/tkzhou/PSPP_Project/PENCOMP_OneTimePoint/variableSelection3/case2/sampleSize", sampleSize, "/")
