...
DIRECOUT="/home/tkzhou/PSPP_Project/PENCOMP_OneTimePoint/variableSelection5/case2/sampleSize1000"
...
simdatG=simulateDate(sampleSize=sampleSize, numPred=numPred, overlapL=level, seed.num=d, rho=0, treatEff=2)
  ...
  modelType="allPot" ###seperate adaptive lasso on the propensity and prediction models
  outcomeVarList0=c("Xc1", "Xc2", "Xp1", "Xp2")
  outcomeVarList1=c("Xc1", "Xc2", "Xp1", "Xp2")
  propenVarList=c("Xc1", "Xc2", "Xp1",  "Xp2", "Xi1", "Xi2", "Xs1", "Xs2", "Xs3" ,"Xs4", "Xs5", "Xs6","Xs7" , "Xs8", "Xs9", "Xs10", "Xs11","Xs12", "Xs13", "Xs14")
...
error=function(e) { }
  ...
  #write.table(varSelectTreat, paste(DIRECOUT, "/bootResults/sample", d, modelType, "_", level, "varSelectTreat.txt",sep=""), row.name=F, quote=F, col.names = varList,
  #            sep="\t")
  
  ####store coefficients of outcome model Y0
  #write.table(varSelectY0, paste(DIRECOUT, "/bootResults/sample", d, modelType, "_", level, "varSelectY0.txt",sep=""), row.name=F, quote=F, col.names = varList,
  #            sep="\t")
