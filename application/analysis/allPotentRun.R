...
#########################################################
DIREC="C:/Users/Tingting.Zhou/Desktop/paper3/biomlatex/Application/"
DIRECOUT="C:/Users/Tingting.Zhou/Desktop/paper3/biomlatex/Application/version4"
...
source(paste0(DIREC, funLoc, "Lasso.R"))
...
for (k in start:end) {
  ...
  varList = c(paste0("LEU3N", 1:4), paste0("LEU2N", 1:4), paste0("WBC", 1:4), paste0("RBC", 1:4), paste0("PLATE", 1:4),
              "age", "white", "college") 
  outcomeVarList0=c(paste0("LEU3N", 1:4), paste0("LEU2N", 1:4), paste0("WBC", 1:4), paste0("RBC", 1:4), paste0("PLATE", 1:4),
                    "age")
  outcomeVarList1=c(paste0("LEU3N", 1:4), paste0("LEU2N", 1:4), paste0("WBC", 1:4), paste0("RBC", 1:4), paste0("PLATE", 1:4),
                    "age")
  ...
  estimate.out=NULL
  estimate.out=pencompLasso(dataOR=simdatFit, data=simdatFit, varList=varList, propenVarList=propenVarList,
    ...
    tryCatch (
      {
        ...
        mulResult = pencompLasso(dataOR=simdatFit, data=bootSample, varList=varList, propenVarList=propenVarList,
                                 outcomeVarList0=outcomeVarList0, outcomeVarList1=outcomeVarList1,
                                 treat.varname=treat.varname, outcome.varname=outcome.varname ) 
