...
####dataOR-original dataset
####data-bootstrap sample
###regular stepwise variable selection


pencompStepwise=function(dataOR, data, varList, propenVarList, outcomeVarList0, outcomeVarList1, treat.varname, outcome.varname,
                         first) {
  tryCatch ( 
    {
      ...
      if ( length(propenVarList)==0 ){
        ...
        propenVarList=stepX(data=data, varList=varList, outcome.varname = treat.varname)
      } 
      ...
      if ( length(outcomeVarList0)==0 & length(outcomeVarList1)==0 ){
        ...
        outcomeVarList0=stepY(data=data, varList=varList, treat.varname=treat.varname, outcome.varname=outcome.varname)
