...
for(sampleSize in c(200, 1000)){
  for(start in seq(1, 500, 500)){
    for (level in c("high", "moderate", "low" ) ) {
      ...
      #DIREC="M:/Private/variableSelection/variableSelection/case2/"
      ...
      batchFile=c(batchFile, paste(
        ...
        "#########################################################",
        "#########################################################",
        paste("DIREC=\"", DIREC, "\"", sep=""),
        paste("DIRECOUT=\"", DIREC, "sampleSize", sampleSize, "\"", sep=""),
        "",
        "funLoc = \"Functions/\"",
        "  ",
      ...
      write.table(batchFile, paste(DIREC, "sampleSize", sampleSize, "/", modelType,"_", level, "_start_", start, ".R",sep=""), row.name=F, col.names=F, quote=F)
